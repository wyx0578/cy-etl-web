...
Depend on `@delon/cli`, [How install?](http://cy-etl-web.com/docs/cli)
...
```bash
# clone a blank cy-etl-web repo, just only basic function
...
+ Support [Electron](http://cy-etl-web.com/docs/cli#electron) packager(just via @delon/cli)
